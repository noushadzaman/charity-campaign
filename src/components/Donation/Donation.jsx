...
const Donation = () => {
    ...
    return (
        <div className="flex flex-col items-center pb-[105px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px] md:mx-[auto] max-w-[1300px] pt-[100px] mx-[20px]">
                {
                    performedDonations.length != 0 ? 
                    ...
                    : 
                    <div>
                        <h2 className="text-[red] text-[50px] text-center">Not Donated yet</h2>
                    </div>
                }
            </div>
            {
